...
const FeedbackMetrics = ({ feedbacks }) => {
  ...
  const recommendationRate = totalFeedbacks > 0 
    ? (feedbacks.filter(feedback => feedback.wouldRecommend).length / totalFeedbacks) * 100 
    : 0;

  const newFeedbacks = feedbacks.filter(feedback => feedback.status === 'new').length;
  const respondedFeedbacks = feedbacks.filter(feedback => feedback.status === 'responded').length;
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="bg-white p-4 rounded-lg shadow-sm text-center">
            ...
            <p className="text-lg font-bold text-purple-600">{totalFeedbacks}</p>
          ...
          <div className="bg-white p-4 rounded-lg shadow-sm text-center">
            ...
            <p className="text-lg font-bold text-green-600">{recommendationRate.toFixed(1)}%</p>
          ...
          <div className="bg-white p-4 rounded-lg shadow-sm text-center">
            ...
            <p className="text-lg font-bold text-blue-600">{responseRate.toFixed(1)}%</p>
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                ...
                <div className="flex items-center space-x-1">
                  ...
                  <span className="text-sm font-medium text-gray-900 ml-1">{averageRating.toFixed(1)}</span>
                </div>
              </div>
              <div className="flex justify-between items-center">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="text-sm font-medium text-green-600">{recommendationRate.toFixed(1)}%</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white p-4 rounded-lg shadow-sm">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                ...
                <span className="text-sm font-medium text-orange-600">{newFeedbacks}</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-sm text-gray-600">Responded</span>
                <span className="text-sm font-medium text-green-600">{respondedFeedbacks}</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-sm text-gray-600">Response Rate</span>
                <span className="text-sm font-medium text-blue-600">{responseRate.toFixed(1)}%</span>
              </div>
            </div>
          </div>
        </div>
